...
if (pets == allowedPets) (petStatus = 'I have enough pets');
if (pets += allowedPets) (petStatus = 'Oh no, I have too many pets!');
...
else (pets <= friendsPets)  (mostPets = friendsPets);
...
try {
  module.exports = {
    ...
    friendsPets: typeof 1 !== 'undefined' ? 1 : undefined,
